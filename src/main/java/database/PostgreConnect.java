...
public class PostgreConnect {
    ...
    public static void insertCountry(Country country) {
        ...
        int id = 0;
        try {
            PreparedStatement statement = connection.prepareStatement("INSERT into country_data (xml_id,iso,heading, subheading, author, general_data, chron_data)" + "VALUES (?,?,?,?,?,?,?)",Statement.RETURN_GENERATED_KEYS);
